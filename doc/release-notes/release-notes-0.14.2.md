DakeCoin Core version 0.14.2 is now available from:

  <https://DakeCoin.org/bin/DakeCoin-core-0.14.2/>
...
(in DakeCoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in DakeCoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate DakeCoin-config.h as necessary (theuni)
