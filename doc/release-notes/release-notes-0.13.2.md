DakeCoin Core version 0.13.2 is now available from:

  <https://DakeCoin.org/bin/DakeCoin-core-0.13.2/>
...
- #8908 `4a974b2` Update DakeCoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow DakeCoin-tx to create v2 transactions (btcdrak)
